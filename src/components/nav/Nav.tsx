...
const [isDarkMode,setDarkMode] = useState(false) 
  ...
  return (
    <nav className="h-[70px] drop-shadow-md ">
        <div className="flex justify-between px-32 items-center h-full dark:bg-dme bg-whitee  ">
            <div >
                <h1 className=" dark:text-whitee text-[1.5rem] font-semibold">Where in the world?</h1>
            </div>
